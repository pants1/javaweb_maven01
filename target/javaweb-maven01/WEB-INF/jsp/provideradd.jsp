...
<div class="right">
    ...
    <div class="providerAdd">
        <form id="providerForm"  onsubmit="return ceckMform()" name="providerForm" method="post" action="${pageContext.request.contextPath}/provider/add">
            ...
            <div class="">
                ...
                <!-- 放置提示信息 -->
                <font id="errorCode" color="red"></font>
            </div>
            <div>
