...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/User/modify.do">
			...
			<input type="hidden" name="uid" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="birthday" value="  <fmt:formatDate value="${user.birthday }" pattern="yyyy-MM-dd"></fmt:formatDate>"
